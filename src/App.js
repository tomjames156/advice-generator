...
function App() {
  ...
  return (
    ...
    <div className="bg-dark-bg w-full h-screen grid grid-cols-1 justify-center items-center">
      ...
      <img className="mt-4 sm:hidden" src="images/pattern-divider-desktop.svg" alt="screen-divider"/>
      <img className="mt-4 hidden sm:block" src="images/pattern-divider-mobile.svg" alt="screen-divider"/>
      <div className="absolute mx-[10rem] align-center flex justify-center p-3 -bottom-4 bg-green-bg rounded-full hover:shadow-dice cursor-pointer">
